...
var nodeType = indeedAriesClient_1.IndeedNodeType.EVU;
var REQ_PRED = [{
        name: "power",
        value: 0,
        type: ">="
...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var communicationHandler, indeedAriesClient, didInfo, resp_nym_register, resp_public_did, invitation_plant, resp_receive_evu_invitation, plantConnectionID, resp_tuevCredentialDefID, tuevCredentialDefID, resp_proof_request, credentialPresentationThreadID, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    communicationHandler = new commuicationBesideAriesHandler_1.CommuicationBesideAriesHandler(nodeType);
                    indeedAriesClient = new indeedAriesClient_1.IndeedAriesClient(nodeType, "http://" + config.agent_url + ":8016", "http://" + config.base_url, "http://" + config.ledger_url, 8103, nodeType, config.log_level);
                    _a.label = 1;
                case 1:
                ...
                case 6:
                    invitation_plant = _a.sent();
                    return [4 /*yield*/, indeedAriesClient.receive_invitation(invitation_plant["body"], true)];
                case 7:
                    resp_receive_evu_invitation = _a.sent();
                    LOGGER.info("EVU: Receive Invitation " + JSON.stringify(resp_receive_evu_invitation));
                    plantConnectionID = resp_receive_evu_invitation["connection_id"];
                ...
                case 8:
                    ...
                    //Get CredID
                    return [4 /*yield*/, communicationHandler.sendMessage(indeedAriesClient_1.IndeedNodeType.TUEV, commuicationBesideAriesHandler_1.CommunicationType.CREDENTIAL_DEFINITION_REQUEST)];
                case 9:
                    //Connection established
                    //Get CredID
                    _a.sent();
                    return [4 /*yield*/, communicationHandler.waitTillEventEmitted(commuicationBesideAriesHandler_1.CommunicationType.CREDENTIAL_DEFINITION_RESPONSE)];
                case 10:
                    resp_tuevCredentialDefID = _a.sent();
                    tuevCredentialDefID = resp_tuevCredentialDefID["body"]["credential_definition_id"];
                    return [4 /*yield*/, indeedAriesClient.sendPlantCredentialProofRequest(tuevCredentialDefID, plantConnectionID, REQ_PRED, REQ_ATTR)];
                case 11:
                    resp_proof_request = _a.sent();
                    LOGGER.info(JSON.stringify(resp_proof_request));
                    credentialPresentationThreadID = resp_proof_request;
                    return [4 /*yield*/, indeedAriesClient.waitTillPresentationVerified(credentialPresentationThreadID)];
                case 12:
                    _a.sent();
