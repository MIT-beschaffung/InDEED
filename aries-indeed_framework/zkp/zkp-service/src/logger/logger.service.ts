...
export class MyLogger implements LoggerService {
    ...
    private logLevel: string = process.env.LOG_LEVEL
    private label: string = "zkp-service";
    private logger = winston.createLogger({levels: myCustomLevels.levels});
    /**
    ...
    initializeLogger(label) {
        ...
        const consoleOptions = {
            level: this.logLevel.toLowerCase(), // Use 'info' or 'warn' to avoid massive logs in docker logs
     ...
     * @param context optional not handled at the moment
     */
    notice(message: any, trace?: string, context?: string) {
        this.logger.log(logLevels.NOTICE, message);
    }
    /**
